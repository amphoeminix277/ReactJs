            ...
            <div className="new-item-panel-container">
                <div className="new-item-panel">
                    <form onSubmit={this.createItem}>
                        <p>
                        <label>Título de la pelicula o serie</label><br />
                        <input type="text" name="title" className="input" onChange={this.onChangeTitle} />
                        </p>

                        <p>
                        <label>Nombre del Wallpaper</label><br />
                        ...
                        <input type="submit" className="button btn-blue" value="Registrar Pelicula o serie" />
